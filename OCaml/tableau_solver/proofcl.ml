...
(* はじめにだけ呼ぶ関数 *)
let init = function
  | WffAtom form -> PrvblFrm (WldAtom 0, false, WffAtom form)
  | WffNot form -> PrvblFrm (WldAtom 0, false, WffNot form)
  | WffArrow (form1, form2) -> PrvblFrm (WldAtom 0, false, WffArrow (form1, form2))
  | WffOr (form1, form2) -> PrvblFrm (WldAtom 0, false, WffOr (form1, form2))
  | WffAnd (form1, form2) -> PrvblFrm (WldAtom 0, false, WffAnd (form1, form2))
