...
window.onload = function(){
  ...
  var setPlayer = function(){
    ...
    if (window.localStorage.getItem('inventory')) {
      ...
      player.inventory = []; // これは元は、もっと下のplayer.facing関数の下にあったコード
    }
  ...
  var setBattle = function(){
    ...
    battle.won = function(){
      ...
      player.statusLabel.text = "戦いに勝った！<br />" +
  ...
  var setShopping = function(){
    ...
    shop.greeting = "ハイ！ 招き猫よ、ミャオ。アイテム売ってるの";
    shop.apology = "ミャオ、ごめんにゃさいね、金貨が足りないの";
    shop.sale = "ありがとうだにゃあ！";
